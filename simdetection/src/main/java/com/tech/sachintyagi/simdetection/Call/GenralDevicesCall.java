...
public class GenralDevicesCall {

    @TargetApi(23)
    public String genralDeviceSIM(Context context, int MAX) {
...
//                tvSim.setText(ValueOfSim);
    ...
    @TargetApi(23)
    public List<CallInfo> genralDeviceSIM(Context context, int MAX, int returntype) {
//        SIMInfoDB(context);
...
//                return ValueOfSim;
    ...
    public void SIMInfoDB(Context context) {
