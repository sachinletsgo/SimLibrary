...
public class GenralDevicesSMS {




    public String generalDeviceSIMSMS(Context context, int MAX) {
...
//                    CallLog.Calls.CONTENT_URI,
    ...
    public List<SMSInfo> generalDeviceSIMSMS(Context context, int MAX, int temp) {
